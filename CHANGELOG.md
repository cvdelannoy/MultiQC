...
## MultiQC modules added for Assembler Benchmark

####New Modules
* [**minimap2**](https://github.com/lh3/minimap2)
    * Parse parse produced alignment fo reads versus a reference to return identity, mismatch, insertion and deletion rates. 
